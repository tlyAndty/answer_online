<template>
  <div class="top">
    <span style="font-size: 30px">问题数据</span>
  ...
  export default {
    ...
    methods: {
      ...
      getListData() {
        if (this.value[1] != 1) {
          console.log("查询年数据")
          this.$axios.post('http://localhost:8080/online_answer/admin/viewQuesnumByYear',
            qs.stringify({
          ...
          console.log("查询周数据")
          this.$axios.post('http://localhost:8080/online_answer/admin/viewQuesnumByDate',
            qs.stringify({
